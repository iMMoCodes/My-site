...
const Projects = () => {
	...
	const [stackTwo, setStackTwo] = useState(null)
	const [stackThree, setStackThree] = useState(null)
	...
	return (
		<main className='projects' id='projects'>
			...
			<div className='my-current-project'>
				...
				<h4>A page where you can register,login and add users to your contacts</h4>
				<div className='my-current-project-buttons'>
					<a target='_blank' rel='noreferrer' href='https://immocontacts.netlify.app'>
						View Live
					</a>
					<a target='_blank' rel='noreferrer' href='https://github.com/iMMoCodes/contact'>
						View Code
					</a>
				</div>
			</div>
